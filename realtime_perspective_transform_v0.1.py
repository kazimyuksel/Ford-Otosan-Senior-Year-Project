...
camera = PiCamera()
camera.resolution = (CAMERA_WIDTH_PIXEL, CAMERA_HEIGHT_PIXEL)
camera.framerate = CAMERA_FRAMERATE
rawCapture = PiRGBArray(camera, size=(CAMERA_WIDTH_PIXEL, CAMERA_HEIGHT_PIXEL))
...
# Area of interest for pixel per radians
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    # Remove Fisheye lens distorsion
